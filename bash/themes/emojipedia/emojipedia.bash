...
# File name   : emojipedi.bash
# Version     : v1.0
# Author      : codeMonkey
# Date        : 2021-12-25
# Description : emojipedi prompt
...
function setup_left_and_right {
    ...
    PS1_LEFT+="\[${BPurple}\] "
    PS1_LEFT+='$(__git_ps1 "%s")'                                      # git repository details
    # PS1_LEFT+="\$(__git_ps1 '(%s)' \"\[${BWhite}\] on \[${BPurple}\]\" \"\[${BBlue}\]\")"     # git repository details
    PS1_LEFT+="\n"                                                                      # newline
    PS1_LEFT+="👉 \[${Color_Off}\]"                                                     # Color_Off color
